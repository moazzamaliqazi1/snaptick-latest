        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <Editor
              ...
              initialValue={profile.bio ? profile.bio : "<p>Please provide a bio about you</p>"}
              init={{
                height: 300,
                menubar: false,
                plugins: [
          ...
          <Grid item xs={12}>
            <Button variant="contained" style={{ color: "white" }} onClick={saveBasicProfileInfo} fullWidth>
              Save
            </Button>
          </Grid>
        </Grid>
